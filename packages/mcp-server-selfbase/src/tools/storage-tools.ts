...
export function getStorageTools({
  ...
  return {
    ...
    create_storage_bucket: injectableTool({
      description: `Creates a new storage bucket in Selfbase.

**Important for Self-Hosted Selfbase:**
...
- allowed_mime_types: Array of allowed MIME types (optional, e.g., ["image/png", "image/jpeg"])`,
    ...
    list_storage_buckets: injectableTool({
      description: 'Lists all storage buckets in a Selfbase project.',
      annotations: {
    ...
    get_storage_config: injectableTool({
      description: 'Get the storage config for a Selfbase project.',
      annotations: {
    ...
    update_storage_config: injectableTool({
      description: 'Update the storage config for a Selfbase project.',
      annotations: {
