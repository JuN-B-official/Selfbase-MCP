...
export function getDebuggingTools({
  ...
  return {
    get_logs: injectableTool({
      description:
        'Gets logs for a Selfbase project by service type. Use this to help debug problems with your app. This will return logs within the last 24 hours.',
      annotations: {
    ...
    get_advisors: injectableTool({
      description:
        "Gets a list of advisory notices for the Selfbase project. Use this to check for security vulnerabilities or performance improvements. Include the remediation URL as a clickable link so that the user can reference the issue themselves. It's recommended to run this tool regularly, especially after making DDL changes to the database since it will catch things like missing RLS policies.",
      annotations: {
